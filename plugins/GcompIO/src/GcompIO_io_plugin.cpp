...
#include <GcompIO_io_plugin.h>

/* Specify that the class XBotPlugin::GcompIO is a XBot RT plugin with name "GcompIO" */
REGISTER_XBOT_IO_PLUGIN_(XBotPlugin::GcompIO)
